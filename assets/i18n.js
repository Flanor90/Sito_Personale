...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'test.faq2.a': 'Nowhere: the tests run entirely in your browser. Answers are not saved, tracked or sent — only you see the result, and you decide whether to share it with me in the contact form. If at the end you choose to leave your email, only that address and the name of the test you have just taken are sent — never your answers, never your result — so that the emails you receive are about the right theme. You can unsubscribe whenever you like.',
      ...
      'comp.new': 'New',
      'comp.c4.badge': 'For therapists',
      'comp.c4.t': 'ADHD and relational trauma',
      'comp.c4.d': 'A compendium for clinicians that reads attentional dysregulation also as the outcome of a relational history, without replacing one label with another: neither only genetics nor only trauma.',
      'comp.c5.badge': 'For those living with ADHD',
      'comp.c5.t': 'More than the diagnosis: ADHD, your history and who you are',
      'comp.c5.d': 'The second volume in the series "Understanding your own mind". You are not broken, you are not lazy and you are not your diagnosis: your attention has a history, and it took shape inside relationships.',
      'comp.c6.badge': 'For clinicians',
      'comp.c6.t': 'ADHD and Relational Trauma',
      'comp.c6.d': 'A standalone English volume, not a translation: it reads attentional dysregulation also as the outcome of a relational history, written for colleagues who work in English.',
      ...
      'foot.nav.newsletter': 'Newsletter',
      ...
      'nl.kicker': 'The newsletter',
      'nl.title': 'One prompt a month, to look inward with more clarity',
      'nl.p': 'Every month I write you a reflection on inner life, a new self-observation tool and news about the compendia. Careful writing, never spam. Unsubscribe with one click, whenever you like.',
      'nl.b1': 'A clinical reflection, written with care',
      'nl.b2': 'New tests and tools before any other channel',
      'nl.b3': 'Excerpts and releases of the compendia',
      'nl.f.email': 'Your email',
      'nl.f.email.ph': 'name@example.com',
      'nl.f.consent': 'I agree to receive the newsletter and to the processing of my email under the <a href="#privacy-newsletter" class="underline underline-offset-2 hover:text-notte">GDPR</a>. Never shared with third parties.',
      'nl.f.cta': 'Subscribe',
      'nl.f.privacy': 'You\'ll get a confirmation email (double opt-in): your subscription is complete only after you click the link inside it. Data is processed in compliance with the GDPR.',
      'test.nl.q': 'The real question now is what to do with it. Leave your email: I\'ll write to you five times on this theme.',
      'test.nl.p': 'How a result like yours is read and how it is <em>not</em> read, how a course of therapy actually works, and a piece of clinical work from the consulting room. After that, one email a month, if you want to stay. Your test answers remain in your browser: here you only leave your address.',
      'test.nl.label': 'Your email',
      'test.nl.ph': 'name@example.com',
      'test.nl.cta': 'Subscribe',
      'test.nl.consent': 'I agree to receive the newsletter and to the processing of my email (GDPR). Unsubscribe with one click, anytime.',
      'comp.nl.title': 'Tell me when a new compendium is out',
      'comp.nl.p': 'Leave your email: I\'ll write to you at every new release, with a preview excerpt. No spam.',
      'comp.nl.label': 'Your email',
      'comp.nl.ph': 'name@example.com',
      'comp.nl.cta': 'Notify me',
      'comp.nl.consent': 'I agree to the processing of my email to receive the alerts (GDPR). Unsubscribe with one click.',
      'foot.nl.title': 'Get the newsletter',
      'foot.nl.p': 'One prompt a month. No spam.',
      'foot.nl.label': 'Your email',
      'foot.nl.ph': 'name@example.com',
      'foot.nl.cta': 'Subscribe',
      'foot.nl.consent': 'I agree to the processing of my email under the GDPR. Double opt-in: confirm by email.',
      'con.f.newsletter': 'Subscribe me to the newsletter too: one prompt a month on inner life and new releases. No spam, unsubscribe with one click.',
      'nl.ok': 'Almost there! I\'ve sent you a confirmation email: click the link inside it to complete your subscription.',
      'nl.ok.mailto': 'Your email app is opening with the request ready: send it to complete.',
      'nl.err.email': 'Please check the email address: it looks incomplete.',
      'nl.err.consent': 'To subscribe, your consent to data processing is required.',
      'nl.err.generic': 'Something went wrong. Please try again, or write to me directly.',
    ...
    es: {
      ...
      'test.faq2.a': 'En ninguna parte: los tests funcionan enteramente en tu navegador. Las respuestas no se guardan, ni se rastrean ni se envían — el resultado lo ves solo tú, y tú decides si compartirlo conmigo en el formulario de contacto. Si al final decides dejar tu email, se envían solo esa dirección y el nombre del test que acabas de hacer — nunca tus respuestas, nunca tu resultado — para que los emails que recibas hablen del tema adecuado. Puedes darte de baja cuando quieras.',
      ...
      'comp.new': 'Nuevo',
      'comp.c4.badge': 'Para terapeutas',
      'comp.c4.t': 'TDAH y trauma relacional',
      'comp.c4.d': 'Un compendio para clínicos que lee la desregulación atencional también como resultado de una historia relacional, sin sustituir una etiqueta por otra: ni solo genética ni solo trauma.',
      'comp.c5.badge': 'Para quien convive con el TDAH',
      'comp.c5.t': 'Más que el diagnóstico: TDAH, tu historia y quién eres',
      'comp.c5.d': 'Segundo volumen de la serie «Entender la propia mente». No estás roto, no eres perezoso y no eres tu diagnóstico: tu atención tiene una historia, y se formó dentro de relaciones.',
      'comp.c6.badge': 'Para clínicos',
      'comp.c6.t': 'ADHD and Relational Trauma',
      'comp.c6.d': 'Volumen autónomo en inglés, no una traducción: lee la desregulación atencional también como resultado de una historia relacional, pensado para colegas que trabajan en inglés.',
      ...
      /* --- Newsletter y captación de emails --- */
      'nl.kicker': 'La newsletter',
      'nl.title': 'Una reflexión al mes, para mirarte dentro con más claridad',
      'nl.p': 'Cada mes te escribo una reflexión sobre la vida interior, una nueva herramienta de autoobservación y las novedades de los compendios. Textos cuidados, nunca spam. Te das de baja con un clic cuando quieras.',
      'nl.b1': 'Una reflexión clínica, escrita con cuidado',
      'nl.b2': 'Nuevos tests y herramientas antes que en otros canales',
      'nl.b3': 'Los extractos y las novedades de los compendios',
      'nl.f.email': 'Tu email',
      'nl.f.email.ph': 'nombre@ejemplo.com',
      'nl.f.consent': 'Acepto recibir la newsletter y el tratamiento de mi email según el <a href="#privacy-newsletter" class="underline underline-offset-2 hover:text-notte">RGPD</a>. Nunca se comparte con terceros.',
      'nl.f.cta': 'Suscribirme',
      'nl.f.privacy': 'Recibirás un email de confirmación (doble opt-in): la suscripción se completa solo al hacer clic en el enlace que contiene. Los datos se tratan conforme al RGPD.',
      'test.nl.q': 'Ahora la pregunta de verdad es qué hacer con esto. Deja tu email: te escribo cinco veces sobre este tema.',
      'test.nl.p': 'Cómo se lee un resultado como el tuyo y cómo <em>no</em> se lee, cómo funciona de verdad un proceso terapéutico, y un fragmento de clínica desde la consulta. Después, un solo email al mes, si quieres quedarte. Tus respuestas al test se quedan en tu navegador: aquí solo dejas la dirección.',
      'test.nl.label': 'Tu email',
      'test.nl.ph': 'nombre@ejemplo.com',
      'test.nl.cta': 'Suscribirme',
      'test.nl.consent': 'Acepto recibir la newsletter y el tratamiento del email (RGPD). Baja con un clic, cuando quieras.',
      'comp.nl.title': 'Avísame cuando salga un nuevo compendio',
      'comp.nl.p': 'Deja tu email: te escribo en cada nueva publicación, con un extracto en avance. Sin spam.',
      'comp.nl.label': 'Tu email',
      'comp.nl.ph': 'nombre@ejemplo.com',
      'comp.nl.cta': 'Avísame',
      'comp.nl.consent': 'Acepto el tratamiento del email para recibir los avisos (RGPD). Baja con un clic.',
      'foot.nl.title': 'Recibe la newsletter',
      'foot.nl.p': 'Una reflexión al mes. Sin spam.',
      'foot.nl.label': 'Tu email',
      'foot.nl.ph': 'nombre@ejemplo.com',
      'foot.nl.cta': 'Suscribirme',
      'foot.nl.consent': 'Acepto el tratamiento de mi email según el RGPD. Doble opt-in: confirmación por email.',
      'con.f.newsletter': 'Suscríbeme también a la newsletter: una reflexión al mes sobre la vida interior y las novedades. Sin spam, baja con un clic.',
      'nl.ok': '¡Casi listo! Te he enviado un email de confirmación: haz clic en el enlace que contiene para completar la suscripción.',
      'nl.ok.mailto': 'Se está abriendo tu programa de correo con la solicitud lista: envíala para completar.',
      'nl.err.email': 'Revisa la dirección de email: parece incompleta.',
      'nl.err.consent': 'Para suscribirte se necesita tu consentimiento al tratamiento de los datos.',
      'nl.err.generic': 'Algo no ha funcionado. Inténtalo de nuevo o escríbeme directamente.',
