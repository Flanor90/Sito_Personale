...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'test.faq2.a': 'Nowhere: the tests run entirely in your browser. Answers are not saved, tracked or sent — only you see the result, and you decide whether to share it with me in the contact form. If at the end you choose to leave your email for the newsletter, only that address is sent (never your answers), and you can unsubscribe whenever you like.',
      ...
      'test.nl.q': 'Was this helpful? Get a new self-observation tool and my reflections every month. Your test answers stay yours: here you only leave your email.',
    ...
    es: {
      ...
      'test.faq2.a': 'En ninguna parte: los tests funcionan enteramente en tu navegador. Las respuestas no se guardan, ni se rastrean ni se envían — el resultado lo ves solo tú, y tú decides si compartirlo conmigo en el formulario de contacto. Si al final decides dejar tu email para la newsletter, se envía solo esa dirección (nunca tus respuestas), y puedes darte de baja cuando quieras.',
      ...
      'test.nl.q': '¿Te ha resultado útil? Recibe cada mes una nueva herramienta de autoobservación y mis reflexiones. Tus respuestas al test siguen siendo tuyas: aquí solo dejas el email.',
